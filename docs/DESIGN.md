...
| | |
|---|---|
| **Document Status** | Draft v0.1 — Initial Architecture |
| **Created** | 2026-06-09 |
...
| **Database** | MySQL — version as provided by host |
...
| `ext-exif` | * | EXIF extraction from uploaded JPEGs |
...
- Applied at image generation time via Intervention Image composite operation
...
| `exif_data` | `JSON` | Nullable, selected EXIF fields |
